...
int test_transform(int argc, char **argv) 
{
    ...
    do
    {
        ...
        gl_simplify::core::Program::Variable transform_location = program.GetVariable("transform");
        ...
        window.Show([&program, &vao, &texture1, &texture2, &transform_location, transform] (GLFWwindow* window) {
                ...
                glm::mat4 result_transform = glm::rotate(transform, (float)glfwGetTime(), glm::vec3(0.0f, 0.0f, 1.0f));
                program.Use([&transform_location, result_transform] (gl_simplify::core::Program& program) {
                    transform_location.SetMat(result_transform);
                });
